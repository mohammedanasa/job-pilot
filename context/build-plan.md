...
Generate a clean professional PDF resume from current profile data using the available model.

**Logic:**

- POST /api/resume/generate
- Reads current profile data from profiles table
- available model generates professional resume content:
  - Professional summary paragraph
  - Polished work experience bullet points
  - Clean professional language throughout
- @react-pdf/renderer renders available model output into clean single-page PDF using renderToBuffer()
